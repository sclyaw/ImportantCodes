...
public class ProjectileVisual : MonoBehaviour
{
    ...
    private void UpdateShadowPosition() {
        ...
        {
            newPosition.x = trajectoryStartPosition.x + projectile.GetNextXTrajectoryPosition() / shadowPositionDivider + projectile.GetNextXPositionCorrectionAbsolute();

        }
        else
        {
            newPosition.y = trajectoryStartPosition.y + projectile.GetNextYTrajectoryPosition() / shadowPositionDivider + projectile.GetNextYPositionCorrectionAbsolute();
